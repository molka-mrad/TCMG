...
<html lang="fr">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Accueil</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Tank Top T-Shirt</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 class="text-black">Raquette</h2>
            ...
            <p><a href="cart.html" class="buy-now btn btn-sm btn-primary">Ajouter au panier</a></p>
              ...
              <div class="item">
                <div class="block-4 text-center">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="#">Pull TCMG</a></h3>
                    <p class="mb-0">le meuilleur pull pour vous</p>
